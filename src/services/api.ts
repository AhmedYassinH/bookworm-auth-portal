...
const API_BASE_URL = "https://elib.ahmedyassin.dev";
...
const mockBookData = [
    ...
    publishers: [
      {
        ...
        contactInfo: "info@bloomsbury.com",
      },
    ],
  ...
  },
  {
    ...
    title: "1984",
    description:
      "A dystopian novel published in 1949 by English author George Orwell.",
    ...
    imageURL: null,
    authors: [
      { id: 2, name: "George Orwell", bio: "English novelist and essayist" },
    ],
    publishers: [
      {
        id: 2,
        name: "Secker & Warburg",
        contactInfo: "contact@seckerandwarburg.com",
      },
    ],
    createdAt: new Date().toISOString(),
  },
  {
    ...
    publishers: [
      { id: 3, name: "T. Egerton", contactInfo: "info@tegerton.com" },
    ],
    createdAt: new Date().toISOString(),
  },
];
  ...
  if (USE_MOCK_API) {
    ...
    if (
      ...
      if (config.url.split("/").length > 2) {
        ...
        const book =
          mockBookData.find((b) => b.id === bookId) || mockBookData[0];
